...
<!-- type: card
title: <div style="text-align:center;width:100%"><img src="https://raw.githubusercontent.com/Fiserv/digital-disbursements/develop/assets/images/icons/Person-and-computer.png" alt="Portal icon" title="Portal icon" style="width:50%; height:auto"></div> Payments Portal
...
<!-- type: card
title: <div style="text-align:center;width:100%"><img src="https://raw.githubusercontent.com/Fiserv/digital-disbursements/develop/assets/images/icons/hosted-pages-icon.png" alt="Hosted pages icon" title="Hosted pages icon" style="width:50%; height:auto"></div> Hosted Payments Page
...
<!-- type: card
title: <div style="text-align:center;width:100%"><img src="https://raw.githubusercontent.com/Fiserv/digital-disbursements/develop/assets/images/icons/api-connection.png" alt="API icon" title="API icon" style="width:50%; height:auto"></div> API Only
...
<!-- type: card
title: <div style="text-align:center;width:100%"><img src="https://raw.githubusercontent.com/Fiserv/digital-disbursements/develop/assets/images/icons/batch-bulk-icon.png" alt="Batch icon" title="Batch icon" style="width:50%; height:auto"></div> Batch and Bulk Options
