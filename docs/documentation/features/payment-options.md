...
Description: Send funds to recipient’s debit card globally
Card associated with recipient’s bank account
...
description: Send payout directly to recipient’s bank
Available to spend in 1 to 2 days through ACH
RTP through The Clearing House available in 2023
-->
...
description: Instant issue digital prepaid card
Load to digital wallet (Apple®, Google®, etc.)
...
Description: Delivered to recipient email or mailing address
Printable by recipient 
Can be physically deposited in bank
Can be deposited through remote deposit capture
-->
...
description: Send funds to recipient’s PayPal account globally
Send funds to recipient’s Venmo account
Funds available to spend in seconds
-->
...
description: Send funds to recipient’s crypto wallet
Multiple wallets available including Coinbase 
Funds available to spend in seconds
-->
